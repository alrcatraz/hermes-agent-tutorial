...
!!! info "本章对应 Astra 生态组件"
    - [`astra-skill-execution-framework`](https://github.com/alrcatraz/astra-skill-execution-framework) — 执行框架
    - [`astra-skill-change-safeguard`](https://github.com/alrcatraz/astra-skill-change-safeguard) — 变更安全
    - [`astra-skill-deploy-register`](https://github.com/alrcatraz/astra-skill-deploy-register) — 部署登记
    - [`astra-skill-pre-action-research`](https://github.com/alrcatraz/astra-skill-pre-action-research) — 预研
    - [`astra-skill-work-closure-check`](https://github.com/alrcatraz/astra-skill-work-closure-check) — 收尾检查
...
```bash
# 克隆到 skills 目录
git clone https://github.com/alrcatraz/astra-skill-pre-action-research.git \
