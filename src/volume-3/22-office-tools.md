...
# 第22章：Office 工具与文档撰写 {#ch:22}

## 22.1 OfficeCLI：无头 Office 文档处理
...
!!! info "参考说明"
    OfficeCLI 的完整 MCP 集成模式、视图模式、高级功能（Word/PPT/Excel 创建与编辑）在 [§22.4](#sec:22.4) 中有详细说明。本节仅介绍安装与基本工具链。

## 22.2 Pandoc：格式转换瑞士军刀
...
## 22.4 OfficeCLI：单二进制全功能 Office 文档处理 {#sec:22.4}
